import{r as h,u as v,a as f,b as i,j as r,N as g,c as b,m as j,L as c,B as N,z as t}from"./index-DqMWGEfX.js";import{a as y}from"./auth-DLfyAGDy.js";function k(){const[o,n]=h.useState({email:"",password:""}),d=v(),m=f(),u=i(e=>e.isAuthenticated),x=i(e=>e.setAuth),s=m.state?.from?.pathname??"/home";if(u)return r.jsx(g,{to:s,replace:!0});const l=b({mutationFn:e=>y.login(e).then(a=>a.data),onSuccess:e=>{x(e.user,e.token),t.success("Welcome back!"),d(s,{replace:!0})},onError:e=>{t.error(e.response?.data?.message??"Login failed")}}),p=e=>{if(e.preventDefault(),!o.email||!o.password){t.error("Please fill in all fields");return}l.mutate(o)};return r.jsx("div",{className:"min-h-screen flex items-center justify-center bg-[var(--color-background)]px-4",children:r.jsx(j.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.4},className:"w-full max-w-md",children:r.jsxs("div",{className:`\r
