import{r as v,u as h,b as i,j as r,N as g,c as f,m as b,L as d,B as w,z as s}from"./index-CagwMh7D.js";import{a as j}from"./auth-DEqnWZHC.js";function C(){const[a,t]=v.useState({name:"",email:"",password:"",rePassword:""}),c=h(),m=i(e=>e.isAuthenticated),u=i(e=>e.setAuth);if(m)return r.jsx(g,{to:"/home",replace:!0});const l=f({mutationFn:e=>j.register(e).then(o=>o.data),onSuccess:e=>{u(e.user,e.token),s.success("Account created!"),c("/home",{replace:!0})},onError:e=>{const o=e.response?.data?.message,n=e.response?.data?.errors;if(n&&Object.keys(n).length){const p=Object.values(n)[0];s.error(p??"Registration failed")}else s.error(o??"Registration failed")}}),x=e=>{if(e.preventDefault(),a.password!==a.rePassword){s.error("Passwords do not match");return}if(!a.name||!a.email||!a.password){s.error("Please fill in all fields");return}l.mutate(a)};return r.jsx("div",{className:"min-h-screen flex items-center justify-center bg-[var(--color-background)] px-4 py-12",children:r.jsx(b.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.4},className:"w-full max-w-md",children:r.jsxs("div",{className:`\r
